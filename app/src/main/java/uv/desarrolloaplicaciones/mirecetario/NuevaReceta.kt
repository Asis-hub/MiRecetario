...
class NuevaReceta : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lista = arrayOf("Ensaladas", "Pastas", "Sopas", "Postres")
        ...
        btnImagenVisible.setOnClickListener{
            if(r1.isChecked){
                ...
                Toast.makeText(this, "Se hizo visible agregar imagen", Toast.LENGTH_SHORT).show()
            }
            if(r2.isChecked){
        ...
        btnRegistrarReceta.setOnClickListener{
            try {
                if(txtMostrarIngredientes.text.isNotEmpty() && txtInstrucciones.text.isNotEmpty()
                    ...
                    Toast.makeText(this, "Se registró la receta", Toast.LENGTH_SHORT).show()
